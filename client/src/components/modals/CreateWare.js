        ...
        >
            ...
            <Modal.Body>
                <Form className={'text-center'}>
                    ...
                    <Form.Control className={'mt-2'} placeholder={'Введите название шмотки'} type={'text'}>

                    </Form.Control>
                    <Form.Control className={'mt-2'} placeholder={'Введите стоимость шмотки'} type={'number'}>

                    </Form.Control>
                    <Form.Control className={'mt-2 '} title={'Добавьте изображение'} type={'file'}>
